...
# offlineimap
alias o 'PYTHONPATH="/opt/homebrew/Cellar/offlineimap/7.3.3/libexec/vendor/lib/python2.7/site-packages" python2 /opt/homebrew/Cellar/offlineimap/7.3.3/libexec/offlineimap.py'
